...
async def show_main_prices(message: Message, i18n):
    await message.answer(i18n("price_main_msg"), parse_mode=None)
...
async def show_review_prices(message: Message, i18n):
    await message.answer(i18n("price_reviews_msg"), parse_mode=None)
...
async def show_photo_video_prices(message: Message, i18n):
    await message.answer(i18n("price_photo_video_msg"), parse_mode=None)
...
async def show_fulfillment_prices(message: Message, i18n):
    await message.answer(i18n("price_fulfillment_msg"), parse_mode=None)
...
async def show_delivery_prices(message: Message, i18n):
    await message.answer(i18n("price_delivery_msg"), parse_mode=None)

@router.message(F.text.in_([
    i18n_manager.get("btn_price_packages", "ru"),
...
@router.message(F.text.in_([
    ...
    i18n_manager.get("btn_price_seo", "am")
]))
async def show_seo_prices(message: Message, i18n):
    await message.answer(i18n("price_seo_msg"), parse_mode=None)
